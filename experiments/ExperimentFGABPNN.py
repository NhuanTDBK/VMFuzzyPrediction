...
def experiment(sliding_number=3, hidden_node=15):
    ...
    ga_estimator = GAEstimator(cross_rate=0.48, mutation_rate=0.02, gen_size=100, pop_size=50)
    ...
    np.savez('model_saved/fuzzy_GABPNN_%s_%s' % (sliding_number, score_rmse), y_pred=ypred_defuzzy, y_true=y_actual_test)
